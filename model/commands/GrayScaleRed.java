...
/**
 * Function object to grayscale an image using its red value.
 * This means each pixel's r, g, and b values are set to the r value.
 */
public class GrayScaleRed implements ICommand {
   ...
   */
  public GrayScaleRed(String fileName, String filePath) {
  ...
  public void applyCommand(IModel m) {
    ...
    m.grayScaleRed(this.fileName, this.filePath);
  }
}
